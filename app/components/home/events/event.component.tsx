...
const Event:React.FC<EventProps> = ({img,maxInvinites,startDate}) => {
  ...
  return (
    <div className='home-event md:w-[22%] relative top-0 left-0'>
      <div className="home-event-image z-20 relative top-0 left-0 rounded-[25px] overflow-hidden">
        <Image src={img} alt='event-image' width={400} height={400} />
      ...
      <div className="event-details-bg bg-white/50 z-10 rounded-[25px] w-[100%] h-[200px] absolute -bottom-[50px] left-0">
        ...
        <div className="event-invinites absolute top-[135%] left-1/2 -translate-x-1/2 z-20 px-10 py-5 -translate-y-[120px] bg-white/50 rounded-[25px] font-bold text-2xl text-center w-[40%] mx-auto">{invinites}</div>
    </div>
  )
}
