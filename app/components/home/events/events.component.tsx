...
const Events = () => {
  return (
    <div className='home-events relative z-10 top-0 left-0'>
      ...
      <Image className="hidden md:visible" src="/assets/events-banner.png" alt='banner' width={1920} height={400} />
      <div className="home-events-items p-2 md:p-0 w-[100%] h-[100%] z-20 md:flex-wrap   md:flex md:justify-center md:items-center gap-5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[55%]">
